...
export function AuditTrailTable({ logs, showPagination = true }: AuditTrailTableProps) {
  ...
  const displayLogs = showPagination ? logs.slice(currentPage * ITEMS_PER_PAGE, (currentPage + 1) * ITEMS_PER_PAGE) : logs;
