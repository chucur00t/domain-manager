...
import { Edit, GanttChartSquare, Trash2, Loader2, PlayCircle } from 'lucide-react';
...
import { activateDomain, deactivateDomain } from '@/lib/actions/domains';
import {
  AlertDialog,
  AlertDialogAction,
  AlertDialogCancel,
...
const statusConfig = {
  pending: { text: 'Pending', variant: 'default' as const, className: "bg-amber-500 hover:bg-amber-600" },
  active: { text: 'Aktif', variant: 'secondary' as const, className: "bg-green-500 hover:bg-green-600 text-secondary-foreground" },
  inactive: { text: 'Tidak Aktif', variant: 'outline' as const },
