...
import type { User, SubdomainApplication, HostingApplication } from '@/lib/types';
import { getUsers, getApplications, getHostingApplications } from '@/lib/firebase/services';
